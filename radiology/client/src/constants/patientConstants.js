...
export const PATIENT_REGISTER_TR_REQUEST = 'PATIENT_REGISTER_TR_REQUEST'
export const PATIENT_REGISTER_TR_SUCCESS = 'PATIENT_REGISTER_TR_SUCCESS'
export const PATIENT_REGISTER_TR_FAIL    = 'PATIENT_REGISTER_TR_FAIL'
...
export const PATIENT_MR_REQUEST = 'PATIENT_MR_REQUEST'
export const PATIENT_MR_SUCCESS = 'PATIENT_MR_SUCCESS'
export const PATIENT_MR_FAIL   = 'PATIENT_MR_FAIL'
export const PATIENT_MR_RESET   = 'PATIENT_MR_RESET'
