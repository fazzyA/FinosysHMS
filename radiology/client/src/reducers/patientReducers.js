...
export const patientMRNoReducer = (state = { patientMRs: [] }, action) => {
  switch (action.type) {
    case PATIENT_MR_REQUEST:
      return { ...state, loading: true }
    case PATIENT_MR_SUCCESS:
      return { loading: false, patientMRs: action.payload }
    case PATIENT_MR_FAIL:
      return { loading: false, error: action.payload }
    case PATIENT_MR_RESET:
      return { patientMRs: [] }
    default:
      return state
  }
